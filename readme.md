This program will prompt users to enter a series of numbers, then allow them to choose whether they want to sort them in ascending or descending order. The sorted list will then be displayed.
